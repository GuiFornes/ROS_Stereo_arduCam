...
def rectifyImages(imL, imR,
                  calib_data='/home/gfornes/catkin_ws/src/stereo_vision/src/stereo_vision/calib_data/calibration.npz',
                  cropped=False):
    """
    Rectify stereo pair
...
def point_cloud_from_stereo(stereo_img):
    """
    Compute point cloud from stereo image.
    :param stereo_img: stereo image
    :return: open3d point cloud
    """
    # Rectify images
    rectified_l, rectified_r = rectifyStereoImage(stereo_img)
    # Compute disparity map
    matchers = Matchers()
    disp = matchers.computeFilteredDisparityMap(rectified_l, rectified_r)
    # Compute point cloud
    with np.load('/home/gfornes/catkin_ws/src/stereo_vision/src/stereo_vision/calib_data/calibration.npz') as data:
