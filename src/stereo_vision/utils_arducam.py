...
import time
import cv2
import stereo_vision.ArducamSDK as ArducamSDK
import stereo_vision.arducam_config_parser as arducam_config_parser
from stereo_vision.ImageConvert import *
...
def readImage_thread():
    ...
    """
    global handle, width, height, save_flag, cfg
    count = 0
    time0 = time.time()
...
def commands_thread():
    ...
    while not rospy.is_shutdown():
        ...
        if input_kb == 'q' or input_kb == 'Q':
            rospy.signal_shutdown("[INFO] Exit asked")
...
def init():
    ...
    # TODO : find how to better load config file (without absolut path)
    config_file_name = "/home/gfornes/catkin_ws/src/stereo_vision/src/stereo_vision/OV5647_stereo_2592x1944_AB.cfg"
